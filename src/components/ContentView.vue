		...
		<div class="content-view main-wrapper">
				<div class="common-condition-box">
						<el-form ref="task" :model="task" :inline="true" :rules="taskRules">
								...
								<el-form-item>
										<el-button type="success" size="mini" @click="comfirmTo">保存</el-button>
								...
								<div class="select-box">
										<el-dropdown @command="handleCommand($event, 0)">
												<span class="el-dropdown-link">
														{{form.db.inputLabel}}<i class="el-icon-arrow-down el-icon--right"></i>
												</span>
												<el-dropdown-menu slot="dropdown">
														<el-dropdown-item :command="item" v-for="(item, index) in form.db.data" :key="index">{{item.label}}
														</el-dropdown-item>
												</el-dropdown-menu>
										</el-dropdown>
								</div>
				...
				<el-card class="origin-card">
						<div slot="header">
								...
								<div class="select-box">
										<el-dropdown @command="handleCommand($event, 1)">
												<span class="el-dropdown-link">
														{{form.db.outputLabel}}<i class="el-icon-arrow-down el-icon--right"></i>
												</span>
												<el-dropdown-menu slot="dropdown">
														<el-dropdown-item :command="item" v-for="(item, index) in form.db.data" :key="index">{{item.label}}
														</el-dropdown-item>
						...
						<div class="body-container">
								...
								<div @click="showField = !showField" class="arrow" :class="{'arrow-down': !showField, 'arrow-up': showField}"><i
